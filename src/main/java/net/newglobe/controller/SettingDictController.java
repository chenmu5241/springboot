...
import net.newglobe.model.SettingsDict;
import net.newglobe.model.SysAccount;
import net.newglobe.model.vo.ListDataResult;
import net.newglobe.model.vo.PageVo;
import net.newglobe.model.vo.PagingDataResult;
import net.newglobe.model.vo.Result;
import net.newglobe.service.SettingsDictService;
...
public class SettingDictController {
	...
	public PagingDataResult<SettingsDict> getData(@ModelAttribute SettingsDict t, PageVo pageVo) {
		...
		try {
			...
			criteria.andCondition("status=1").andCondition("dict_type=1");
